...
function Footer() {
      ...
      return (
            ...
            <div className="space-y-6">
                    <h3 className="text-sm font-bold text-primary-accent uppercase tracking-widest mb-4">CAM KẾT DỊCH VỤ</h3>
